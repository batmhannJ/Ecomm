...
export const Dashboard = () => {
  ...
  useEffect(() => {
    const fetchTotalRevenue = async () => {
      try {
        ...
        const response = await fetch('https://tienda-backend-au3t.onrender.com/api/transactions/totalAmount');
  ...
  useEffect(() => {
    const fetchAverageOrderValue = async () => {
      try {
        const response = await fetch('https://tienda-backend-au3t.onrender.com/api/transactions/averageOrderValue');
  ...
  useEffect(() => {
    const fetchMostProducedProduct = async () => {
      try {
        const response = await fetch('https://tienda-backend-au3t.onrender.com/api/transactions/mostProducedProduct');
  ...
  useEffect(() => {
    const fetchSalesByProduct = async () => {
      try {
        const response = await fetch('https://tienda-backend-au3t.onrender.com/api/transactions/salesByProduct');
  ...
  useEffect(() => {
    const fetchSalesByCategory = async () => {
      try {
        const response = await fetch('https://tienda-backend-au3t.onrender.com/api/transactions/salesByCategory');
        if (!response.ok) throw new Error(`Network response was not ok, status: ${response.status}`);
        const data = await response.json();
  ...
  useEffect(() => {
    const fetchSalesGrowthRate = async () => {
      try {
        const response = await fetch('https://tienda-backend-au3t.onrender.com/api/transactions/salesGrowthRate');
        if (!response.ok) throw new Error(`Network response was not ok, status: ${response.status}`);
        const data = await response.json();
  ...
  useEffect(() => {
    const fetchTopPurchasesProduct = async () => {
      try {
        const response = await fetch('https://tienda-backend-au3t.onrender.com/api/transactions/topPurchasesProduct');
        if (!response.ok) throw new Error(`Network response was not ok, status: ${response.status}`);
        const data = await response.json();
