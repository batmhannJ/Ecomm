...
export const PlaceOrder = () => {
  ...
  const fetchCoordinates = async (address) => {
    ...
    const url = `https://api.positionstack.com/v1/forward?access_key=c60e6af4b3421c7b225c09fa354560ec&query=${address}`;
  ...
  const handleProceedToCheckout = async (event) => {
    ...
    if (token) {
      ...
      const mayaApiUrl = "https://pg.paymaya.com/checkout/v1/checkouts";
      ...
      try {
        ...
        if (response.data && response.data.redirectUrl) {
          ...
          updateStock();
          await axios.delete(`https://ip-tienda-han-backend.onrender.com/api/cart/${userId}`); // Clear cart after checkout
